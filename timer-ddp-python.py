...
def changed(collection, id, fields, cleared):
    ...
    if collection == 'leds':
        ...
        if ledcontrol['checked'] == False and ledcontrol['pin'] == 16 and ledcontrol['macAddr'] == newmac:
            print('* LED1 CHECKED FALSE')
            GPIO.output(16, False)
        if ledcontrol['checked'] == True and ledcontrol['pin'] == 16 and ledcontrol['macAddr'] == newmac:
            print('* LED1 CHECKED True')
            GPIO.output(16, True)
        if ledcontrol['checked'] == False and ledcontrol['pin'] == 12 and ledcontrol['macAddr'] == newmac:
            print('* LED2 CHECKED FALSE')
            GPIO.output(12, False)
        if ledcontrol['checked'] == True and ledcontrol['pin'] == 12 and ledcontrol['macAddr'] == newmac:
            print('* LED2 CHECKED True')
            GPIO.output(12, True)
        if ledcontrol['checked'] == False and ledcontrol['pin'] == 18 and ledcontrol['macAddr'] == newmac:
            print('* LED3 CHECKED FALSE')
            GPIO.output(18, False)
        if ledcontrol['checked'] == True and ledcontrol['pin'] == 18 and ledcontrol['macAddr'] == newmac:
            print('* LED3 CHECKED True')
            GPIO.output(18, True)
    	if ledcontrol['checked'] == False and ledcontrol['pin'] == 22 and ledcontrol['macAddr'] == newmac:
            print('* LED4 CHECKED FALSE')
            GPIO.output(22, False)
        if ledcontrol['checked'] == True and ledcontrol['pin'] == 22 and ledcontrol['macAddr'] == newmac:
            print('* LED4 CHECKED True')
            GPIO.output(22, True)
   	if ledcontrol['checked'] == False and ledcontrol['pin'] == 11 and ledcontrol['macAddr'] == newmac:
            print('* LED5 CHECKED FALSE')
            GPIO.output(11, False)
        if ledcontrol['checked'] == True and ledcontrol['pin'] == 11 and ledcontrol['macAddr'] == newmac:
            print('* LED5 CHECKED True')
            GPIO.output(11, True)
   	if ledcontrol['checked'] == False and ledcontrol['pin'] == 15 and ledcontrol['macAddr'] == newmac:
            print('* LED6 CHECKED FALSE')
            GPIO.output(15, False)
        if ledcontrol['checked'] == True and ledcontrol['pin'] == 15 and ledcontrol['macAddr'] == newmac:
...
while True:
    try:
        ...
        if humidity is not None and temperature is not None:
            ...
            client.call('sensordata' , [temperature, humidity, newmac])
        else:
             print 'Failed to get reading. Try again!'
        a = 0  
